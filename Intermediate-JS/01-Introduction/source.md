...
## Bonus: Jawaban introduction.js

```javascript
// introduction.js

// Tidak ada kode yang perlu ditulis untuk latihan ini!
// Cukup jalankan atau tekan "Complete" untuk melanjutkan.

console.log("Ready for Intermediate JavaScript and ES6! 🚀");